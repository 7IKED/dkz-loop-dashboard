...
![Lines](https://img.shields.io/badge/Lines-1346-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-loop-dashboard.git

# Oeffnen
cd dkz-loop-dashboard
